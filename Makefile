...
CFLAGSMIN = -fPIC -Wall -Wextra -std=c99 -msoft-float -Ikernel/src -Ikernel/src/syscall -Ikernel/src/multitasking \
							-Itest-resources -Iusr -Iusr/test -Itest/iio -Itest/messaging -Itest/nameserver -Ilib -Ilib/buffertypes -Ilib/track -Iinclude/ -fno-builtin $(BWLOG_FLAG) $(IOINTERRUPT_FLAG) $(TIMER_INTERRUPTS_FLAG)
