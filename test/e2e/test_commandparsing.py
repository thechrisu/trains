...
class TestCommandParsing(unittest.TestCase):
    def test_quit(self):
        self.assertEqual(qemu_oneshot_test('k4', 'q\r', TIMEOUT, timer_interrupts_on=True, iointerrupts_on=True), cmd_line(12, 2) + 'q' + hide_cursor_line + show_cursor + kexit_msg)
