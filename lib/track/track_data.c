...
#pragma GCC diagnostic pop
  ...
  default_value default_speeds[] = {
    ...
    { .train = 24, .speed = 10, .value = 34164 },
    { .train = 24, .speed = 11, .value = 44852 },
    { .train = 24, .speed = 12, .value = 47342 },
    { .train = 24, .speed = 13, .value = 54960 },
    { .train = 24, .speed = 14, .value = 61869 },
  ...
  default_value default_stopping_distances[] = {
    ...
    { .train = 24, .speed = 14, .value = 133575 },
    { .train = 58, .speed = 0, .value = 0 },
    ...
    { .train = 58, .speed = 12, .value = 74839 },
    { .train = 58, .speed = 13, .value = 93892 },
    { .train = 58, .speed = 14, .value = 133575 },
    { .train = 74, .speed = 0, .value = 0 },
  ...
  default_value default_stopping_times[] = {
    ...
    { .train = 58, .speed = 12, .value = 2410000 },
